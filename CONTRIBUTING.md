...
This file holds no secrets (just id and type), but like the rest of `config/nodes/`
it's gitignored — only `config/nodes/example.yaml` is tracked. The physical wiring
